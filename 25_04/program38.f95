...
PROGRAM prog38
    ...
    WRITE (UNIT=*, FMT="('artosc macierzy v', 6(E10.3,5X))")v

    WRITE (UNIT=*, FMT="('artosc macierzy v', 6(E10.1,5X))")v

    WRITE (UNIT=*, FMT="('artosc macierzy v', 6(ES10.2,5X))")v

    WRITE (UNIT=*, FMT="('artosc macierzy v', 6(EN12.4,5X))")v
